      ...
      <div className='max-w-screen-2xl container mx-auto md:px-20 px-4 flex flex-col md:flex-row my-8'>
        ...
        <div className='w-full order-2 md:order-1 md:w-1/2 mt-12 md:mt-30'>
          <div className='space-y-8'>
            ...
            <p className='bold text-sm md:text-xl  '>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Dolor, et totam. Tempora amet atque expedita, quae corrupti totam sed pariatur corporis at veniam est voluptas animi!</p>
        ...
        <div className=' order-1  w-full  mt-15 md:w-1/2'>
          <img src={banner} alt=""
