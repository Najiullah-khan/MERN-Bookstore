...
function Navbar() {
    ...
    const toggleTheme = () => {
        ...
        document.documentElement.setAttribute('data-theme', newTheme); // For applying the theme
    };
    ...
    return (
        <div className="max-w-screen-2xl mx-auto sticky top-0 z-50">
